...
[[ -d "$PROJECT_ROOT/output_PDF" ]] || fail "Missing persistent PDF output directory: output_PDF"
...
cmp -s "$PROJECT_ROOT/codex/skills/ars-literature-workflow/SKILL.md" "$CONFIG_DIR/skills/ars-literature-workflow/SKILL.md" || fail "Installed ars-literature-workflow skill is stale; rerun scripts/install-portable.sh"
